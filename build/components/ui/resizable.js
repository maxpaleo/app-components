...
const ResizablePanelGroup = (_a) => {
    ...
    return (React.createElement(ResizablePrimitive.PanelGroup, Object.assign({ className: (0, utils_1.cn)("flex h-full w-full data-[panel-group-direction=vertical]:flex-col", className) }, props)));
};
