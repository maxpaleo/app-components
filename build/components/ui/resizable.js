...
const ResizablePanelGroup = (_a) => {
    ...
    return ((0, jsx_runtime_1.jsx)(ResizablePrimitive.PanelGroup, Object.assign({ className: (0, utils_1.cn)("flex h-full w-full data-[panel-group-direction=vertical]:flex-col", className) }, props)));
};
