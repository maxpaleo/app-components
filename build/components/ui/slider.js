...
const Slider = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(SliderPrimitive.Root, Object.assign({ ref: ref, className: (0, utils_1.cn)("relative flex w-full touch-none select-none items-center", className) }, props),
