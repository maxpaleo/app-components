...
const InputOTP = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(input_otp_1.OTPInput, Object.assign({ ref: ref, containerClassName: (0, utils_1.cn)("flex items-center gap-2 has-[:disabled]:opacity-50", containerClassName), className: (0, utils_1.cn)("disabled:cursor-not-allowed", className) }, props)));
});
exports.InputOTP = InputOTP;
InputOTP.displayName = "InputOTP";
const InputOTPGroup = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (React.createElement("div", Object.assign({ ref: ref, className: (0, utils_1.cn)("flex items-center", className) }, props)));
});
...
const InputOTPSlot = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement("div", Object.assign({ ref: ref, className: (0, utils_1.cn)("relative flex h-10 w-10 items-center justify-center border-y border-r border-input text-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md", isActive && "z-10 ring-2 ring-ring ring-offset-background", className) }, props),
        char,
...
const InputOTPSeparator = React.forwardRef((_a, ref) => {
    var props = __rest(_a, []);
    return (React.createElement("div", Object.assign({ ref: ref, role: "separator" }, props),
        React.createElement(lucide_react_1.Dot, null)));
});
