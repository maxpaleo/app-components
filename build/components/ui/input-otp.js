...
const InputOTP = React.forwardRef((_a, ref) => {
    ...
    return ((0, jsx_runtime_1.jsx)(input_otp_1.OTPInput, Object.assign({ ref: ref, containerClassName: (0, utils_1.cn)("flex items-center gap-2 has-[:disabled]:opacity-50", containerClassName), className: (0, utils_1.cn)("disabled:cursor-not-allowed", className) }, props)));
});
...
const InputOTPSeparator = React.forwardRef((_a, ref) => {
    var props = __rest(_a, []);
    return ((0, jsx_runtime_1.jsx)("div", Object.assign({ ref: ref, role: "separator" }, props, { children: (0, jsx_runtime_1.jsx)(lucide_react_1.Dot, {}) })));
});
