...
const SelectScrollUpButton = React.forwardRef((_a, ref) => {
    ...
    return ((0, jsx_runtime_1.jsx)(SelectPrimitive.ScrollUpButton, Object.assign({ ref: ref, className: (0, utils_1.cn)("flex cursor-default items-center justify-center py-1", className) }, props, { children: (0, jsx_runtime_1.jsx)(lucide_react_1.ChevronUp, { className: "h-4 w-4" }) })));
});
exports.SelectScrollUpButton = SelectScrollUpButton;
SelectScrollUpButton.displayName = SelectPrimitive.ScrollUpButton.displayName;
const SelectScrollDownButton = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return ((0, jsx_runtime_1.jsx)(SelectPrimitive.ScrollDownButton, Object.assign({ ref: ref, className: (0, utils_1.cn)("flex cursor-default items-center justify-center py-1", className) }, props, { children: (0, jsx_runtime_1.jsx)(lucide_react_1.ChevronDown, { className: "h-4 w-4" }) })));
});
