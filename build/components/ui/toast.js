...
const Toast = React.forwardRef((_a, ref) => {
    ...
    return ((0, jsx_runtime_1.jsx)(ToastPrimitives.Root, Object.assign({ ref: ref, className: (0, utils_1.cn)(toastVariants({ variant }), className) }, props)));
});
exports.Toast = Toast;
...
const ToastTitle = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return ((0, jsx_runtime_1.jsx)(ToastPrimitives.Title, Object.assign({ ref: ref, className: (0, utils_1.cn)("text-sm font-semibold", className) }, props)));
});
exports.ToastTitle = ToastTitle;
ToastTitle.displayName = ToastPrimitives.Title.displayName;
const ToastDescription = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return ((0, jsx_runtime_1.jsx)(ToastPrimitives.Description, Object.assign({ ref: ref, className: (0, utils_1.cn)("text-sm opacity-90", className) }, props)));
});
